...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Sethupathi Institute Of Higher Studies, Tatabad,Coimbatore,Tamilnadu India"/>
    <meta name="keywords" content="Study center,study center coimbatore, Bharathiyar university,distances education,open university,pride,periyar university"/>
     <link rel="shortcut icon" href="image/hoicon.jpg">
    <title>Contact Us - Sethupathi Institute Of Higher Studies</title>
      ...
      <div class="row">
        <div class="col-lg-5 col-sm-5 address">
          <section class="contact-infos">
            ...
            <address>No.2, Pykara Office Road, Tatabad,Coimbatore
             <br>Tamil Nadu  641012. <br>
 INDIA
            </address>
          </section>
          <section class="contact-infos">
          ...
          <div class="contact-form">
            <form role="form" method="post">
              ...
              <div class="form-group">
                ...
                <input type="text" required name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" class="form-control">
              </div>
              <div class="form-group">
                <label for="phone">
                  Mobile Number
                </label>
                <input type="text" name="phone" pattern="[789][0-9]{9}" maxlength="10" onKeyUp="this.value=this.value.replace(/[^0-9,\.]/g,'');" required class="form-control">
              </div>
              <div class="form-group">
                <label for="phone">
                  Message
                </label>
                <textarea name="message" style="resize: none" rows="5" required class="form-control"></textarea>
              </div>
