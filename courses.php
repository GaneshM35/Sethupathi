...
<html lang="en">
  <head>
  	<title>Courses - Study Services</title>
    <meta charset="utf-8">
    ...
    <div class="container mar-b-30">
      ...
      <div class="row mtop30">
        <div class="col-lg-6 col-sm-6">
          <div class="full-width-media-text">
            <h4>
            <b>Bharathiyar University</b>
            </h4>
            <span><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#buug">UG</button>

  <!-- Modal -->
  <div class="modal fade" id="buug" role="dialog">
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Alagappa University</h4>
        </div>
        <div class="modal-body">
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Rajasthan University</h4>
        </div>
        <div class="modal-body">
          <iframe src="bucourses.php" width="550px" height="300px" >
			</iframe>
